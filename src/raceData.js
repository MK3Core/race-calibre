...
export const racingSeries = {
  f1: {
    ...
    races: [
      ...
      { name: 'Bahrain Grand Prix', location: 'Sakhir', dateTimeUTC: '2026-04-12T15:00:00Z', timezone: 'Asia/Bahrain', cancelled: true },
      { name: 'Saudi Arabian Grand Prix', location: 'Jeddah', dateTimeUTC: '2026-04-19T17:00:00Z', timezone: 'Asia/Riyadh', cancelled: true },
  ...
  wec: {
    ...
    races: [
      { name: '1812km of Qatar', location: 'Lusail', dateTimeUTC: '2026-03-28T13:00:00Z', timezone: 'Asia/Qatar', cancelled: true },
